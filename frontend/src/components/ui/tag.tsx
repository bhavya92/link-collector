...
export const Tag = ({tagName, deleteTag, id, setTagId} : Tag) => {
    ...
    return <div className={`relative transition-all duration-200 group 
                            flex items-center justify-center px-2 py-0.5 text-xs 
                            text-slate-600 w-fit h-fit rounded-xl border border-slate-300 `}
